...
class OrderControllerTest {
    ...
    void placeOrder_invalidSide_throwsIllegalArgumentException() {
        PlaceOrderRequest request = new PlaceOrderRequest("BTC", "INVALID", "LIMIT", null, 10_000L, 1L);
    ...
    void placeOrder_invalidOrderType_throwsIllegalArgumentException() {
        PlaceOrderRequest request = new PlaceOrderRequest("BTC", "BUY", "INVALID", null, 10_000L, 1L);
    ...
    void placeOrder_limitWithoutPrice_delegatesToUseCase() {
        PlaceOrderRequest request = new PlaceOrderRequest("BTC", "BUY", "LIMIT", null, null, 1L);
    ...
    void placeOrder_invalidSideAndOrderType_throwsIllegalArgumentException() {
        PlaceOrderRequest request = new PlaceOrderRequest("BTC", "WRONG", "BAD", null, null, 1L);
    ...
    void placeOrder_validRequest_delegatesToUseCaseAndReturnsAccepted() {
        PlaceOrderRequest request = new PlaceOrderRequest("BTC", "BUY", "LIMIT", null, 10_000L, 1L);
        when(placeOrderUseCase.placeOrder(any())).thenReturn("order-1");
